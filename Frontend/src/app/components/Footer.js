...
export default function Footer() {
  ...
  const Resources = ["Articles", "Blog", "Chart Sheet", "Code challenges", "Docs"];
  const Plans = ["Paid memberships", "For students", "Business solutions"];
  const Community = ["Forums", "Chapters", "Events"];
  const Company = ["About", "Careers", "Affiliates"];

  return (
    <Box component="footer" sx={{ backgroundColor: "#111827", color: "#E5E7EB", pt: 8 }}>
        ...
        <Grid container spacing={6} justifyContent="space-between">
          ...
          <Grid item xs={12} md={3}>
            ...
            {Company.map((item, idx) => (
              <Typography key={idx} variant="body2" sx={{ mb: 0.5 }}>{item}</Typography>
            ))}
          ...
          <Grid item xs={12} md={3}>
            ...
            <Typography variant="h6" sx={{ fontWeight: "bold", mt: 3, mb: 1 }}>Support</Typography>
          ...
          <Grid item xs={12} md={3}>
            ...
            <Typography variant="h6" sx={{ fontWeight: "bold", mt: 3, mb: 1 }}>Community</Typography>
